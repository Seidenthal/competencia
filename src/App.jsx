  ...
  <li className="ml-5">
    <Link to="/loginAdmin" className="text-lg text-white no-underline p-2 hover:bg-customOrange transition duration-300">Administração</Link>
      ...
      <main className="relative h-screen flex flex-col justify-center items-center text-center text-white p-5">
        ...
        <div className="absolute top-0 left-0 w-full h-full bg-cover bg-center opacity-100 z-[-1] bg-black brightness-25" style={{ backgroundImage: "url('/imagens/Fundo.jpeg')" }}></div>
        <div className="z-10 text-customPurple">
          <h1 className="text-6xl mb-8 text-white font-bold">Meninas Digitais</h1>
