...
const Sobre = () => {
  return (
    <div className="bg-pink-100 min-h-screen flex flex-col">
      <header className="flex justify-between items-center p-4 bg-customPurple">
        ...
        <nav>
          <ul className="flex list-none m-0 p-0 mr-28">
            <li className="ml-5">
             <Link to="/" className="text-lg text-white no-underline p-2 hover:bg-customOrange transition duration-300">Página Inicial</Link>
            </li>
          </ul>
        </nav>
      </header>
        ...
        <section className="flex justify-between items-center max-w-5xl w-full mt-5 mb-10">
          <div className="w-3/5">
            ...
            <p className="text-lg leading-relaxed mb-5">
              <i className="fas fa-envelope mr-2"></i> E-mail: <a href="mailto:meninasdigitaisutfprcp@gmail.com" className="hover:underline hover:text-customOrange">meninasdigitaisutfprcp@gmail.com</a>
            </p>
            <p className="text-lg leading-relaxed">
              <i className="fab fa-instagram mr-2"></i> Instagram: <a href="https://www.instagram.com/meninasdigitaisutfprcp/" target="_blank" rel="noopener noreferrer" className="hover:underline hover:text-customOrange">@meninasdigitaisutfprcp</a>
            </p>
          </div>
          <div className="w-2/0 text-center">
            <img src="/imagens/logo4.jpg" alt="Logo Meninas Digitais" className="max-w-full h-auto" />
          </div>
        </section>
      </main>
      <footer className="bg-customOrange text-white text-center p-12">
